        ...
        <div className="p-4 pb-40 animate-fade-in">
            <div className="space-y-4">
                {cartItems.map(item => {
                    ...
                    // FIX: Operator '+' cannot be applied to types 'number' and 'unknown'. Replaced reduce with a for-of loop for robust type safety and to resolve the potential type inference issue.
                    let optionsTotal = 0;
