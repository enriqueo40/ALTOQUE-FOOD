                    ...
                    {view === 'cart' && (
                        <div className="p-5 animate-fade-in pb-48">
                            ...
                            <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto p-8 bg-gray-900/95 backdrop-blur-xl border-t border-gray-800 z-40 rounded-t-[3rem]">
                                 ...
                                 <button disabled={cartItems.length === 0} onClick={() => setView('checkout')} className="w-full bg-emerald-600 py-5 rounded-2xl font-black text-white shadow-2xl active:scale-[0.98] transition-all disabled:opacity-30 uppercase tracking-[0.2em] text-sm">
                        ...
                        <div className="p-12 text-center h-full flex flex-col items-center justify-center gap-8 animate-fade-in">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto font-medium">
                                    {isFinalPayment ? 'Hemos recibido tu reporte de pago satisfactoriamente. ¡Gracias por visitarnos!' : 'Tu ronda ha sido enviada. Puedes seguir pidiendo más cosas desde el menú cuando gustes.'}
                                </p>
                            </div>
                ...
                {view === 'menu' && (
                    <div className="fixed bottom-8 left-6 right-6 max-w-md mx-auto z-40 flex flex-col gap-3">
                        ...
                        {cartItems.length > 0 && (
                            ...
                            >
                                <span className="tracking-[0.2em] uppercase text-[10px]">REVISAR RONDA ({cartItems.length})</span>
