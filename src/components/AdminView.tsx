                                ...
                                <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg text-center">
                                    ...
                                    {order.paymentProof && (
                                        <div className="mt-3">
                                            ...
                                            <a href={order.paymentProof} target="_blank" rel="noreferrer" className="block">
                                                <img src={order.paymentProof} alt="Comprobante" className="w-full h-24 object-cover rounded-lg border dark:border-gray-600 hover:opacity-90 transition-opacity"/>
                                            </a>
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="mt-3 animate-fade-in">
                        ...
                        <div className="relative rounded-md shadow-sm w-40">
                            ...
                            <input
                                ...
                                className="block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 pl-7 pr-3 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm py-2 dark:text-white"
                                placeholder="0.00"
                            />
                        </div>
                    </div>
...
const PaymentSettingsView: React.FC<{ onSave: () => Promise<void>; settings: AppSettings, setSettings: React.Dispatch<React.SetStateAction<AppSettings>> }> = ({ onSave, settings, setSettings }) => {
    ...
    const availableMethods: PaymentMethod[] = ['Efectivo', 'Pago Móvil', 'Transferencia', 'Zelle', 'Punto de Venta'];
    ...
    const inputClasses = "w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm";

    return (
        <div className="space-y-6">
            <SettingsCard title="Métodos de pago" onSave={onSave} onCancel={handleCancel}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h4 className="font-semibold">Para recoger / En mesa</h4>
                        <div className="mt-3 space-y-2">
                             {availableMethods.map(method => (
                                <label key={method} className="flex items-center">
            ...
            {/* Pago Movil Configuration */}
            <SettingsCard title="Configuración Pago Móvil" noActions>
                <div className="space-y-4">
                    <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">C.I. / RIF</label>
            ...
            <SettingsCard title="Configuración Transferencia Bancaria" noActions>
                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Banco</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">C.I. / RIF</label>
                        <input type="text" value={settings.payment.transfer?.idNumber || ''} onChange={e => setSettings(p => ({...p, payment: {...p.payment, transfer: {...p.payment.transfer, idNumber: e.target.value} as any}}))} className={inputClasses} placeholder="J-12345678-9"/>
                    </div>
                </div>
            </SettingsCard>

             <SettingsCard title="Opciones adicionales" onSave={onSave} onCancel={handleCancel} noActions>
                <label className="flex items-center">
