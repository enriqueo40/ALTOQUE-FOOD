...
const DatabaseSettingsView: React.FC = () => {
    return (
        <div className="space-y-6">
            <SettingsCard title="Base de Datos" noActions>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    Aquí puedes ver el estado de tu conexión a Supabase. Para reiniciar la base de datos, ejecuta el script SQL de configuración.
                </p>
                <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded text-sm font-mono text-gray-700 dark:text-gray-300">
    ...
    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-200 overflow-hidden transition-colors duration-200">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                />
                <main className="flex-1 overflow-auto p-8 scroll-smooth bg-gray-50 dark:bg-gray-900/50">
